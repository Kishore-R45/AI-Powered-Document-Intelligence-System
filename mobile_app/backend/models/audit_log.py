...
class AuditLog:
    ...
    ACTION_BIOMETRIC_ENABLE = 'biometric_enable'
    ACTION_BIOMETRIC_DISABLE = 'biometric_disable'
    ACTION_BIOMETRIC_LOGIN = 'biometric_login'
    ACTION_FCM_REGISTER = 'fcm_register'
    ...
    def to_dict(log: dict) -> dict:
        ...
        return {
            ...
            'userId': str(log['user_id']) if log.get('user_id') else None,
